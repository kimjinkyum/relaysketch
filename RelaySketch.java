...
public class RelaySketch {
   ...
   public static int check_IP=0; //패키지 변수
   ...
   public void initialize() {
      ...
      btnNewButton.setEnabled(false);//소영
      ...
      btnNewButton.setBackground(Color.WHITE); //은서
...

{
   ...
   if(afu==1) {
      ...
      btnB.setBackground(Color.WHITE);//은서
      ...
      submit_name.setBackground(Color.WHITE); //은서
      ...
      lblRelaySketch.setForeground(Color.WHITE); //은서
